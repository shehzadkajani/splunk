...
def build_subscription_update(search, visualization_data, job_status):
    ...
    if search.trellis_enabled:
        ...
        trellis_visualization_data = process_trellis_format(visualization_data, search.trellis_split_by)
        subscription_update = TrellisDashboardVisualizationEvent(
            dashboard_visualization_id=dashboard_visualization_id, trellis_visualization_data=trellis_visualization_data,
...
async def get_running_search_job_content(auth_header, owner=None, app_name=None, sid=None, async_splunk_client=None):
    """
    ...
    for subscription in subscriptions:
        ...
        try:
            ...
            LOGGER.info(
                ...
                send_message_request.ByteSize(), request_id, update_id, subscription.key(),
